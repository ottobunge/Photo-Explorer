...
FACE_TEST_IMAGES = [
    ...
    (
        "face_014.jpg",
        "https://images.unsplash.com/photo-1521575107034-e0fa0b594529?w=800",
    ),  # Business team
    (
        "face_015.jpg",
    ...
    (
        "face_018.jpg",
        "https://images.unsplash.com/photo-1525598912003-663126343e1f?w=800",
    ),  # Angled portrait
    ...
    (
        "face_020.jpg",
        "https://images.unsplash.com/photo-1506919258185-6078bba55d2a?w=800",
    ),  # Natural lighting
]
