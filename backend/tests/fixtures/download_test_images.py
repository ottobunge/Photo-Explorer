...
Images use their original Unsplash IDs as filenames - testing relies on AI analysis.
...
# Filenames will be extracted from photo IDs in URLs
TEST_IMAGES = [
    # Animals (15 images)
    ...
    "https://images.unsplash.com/photo-1551715130-b23fa4c642e3?w=800",
    "https://images.unsplash.com/photo-1470093851219-69951fcbb533?w=800",
    ...
    "https://images.unsplash.com/photo-1551715373-1c8e6e7f4c4b?w=800",
...
def download_file(url: str, dest_path: Path, retries: int = 3) -> bool:
    ...
    for attempt in range(retries):
        try:
            ...
            req = Request(
                url, headers={"User-Agent": "Mozilla/5.0 (compatible; PhotoExplorerTests/1.0)"}
            )
...
def main():
    ...
    readme_path.write_text(
        """# Test Images for Semantic Search

This directory contains 50 diverse test images downloaded from Unsplash for testing
semantic search functionality.

## Contents
50 images with original Unsplash IDs as filenames containing:
...
## Purpose
Files use original Unsplash photo IDs (e.g., 1514888286974-6c03e2ca1dba.jpg).
Semantic search testing relies on AI analysis rather than filename hints.
